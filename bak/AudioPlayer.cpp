...
QQueue<AVFrame> *AudioPlayer::mFrameQueue = new QQueue<AVFrame>();
...
//    memcpy(stream, mSrcData, len);////如果声音大小是SDL_MIX_MAXVOLUME就等价于SDL_MixAudioFormat(stream,mSrcData,AUDIO_S16SYS,len,SDL_MIX_MAXVOLUME);
